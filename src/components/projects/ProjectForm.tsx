    ...
    return (
        <>
            <div className="mb-5 flex flex-col gap-3 mt-3">
                <label htmlFor="projectName" className="text-base text-(--white)/50">Project Name</label>
                <input
                    id="projectName"
            ...
            <div className="mb-5 flex flex-col gap-3">
                <label htmlFor="clientName" className="text-base text-(--white)/50">
                    Client name
                </label>
                <input
                    id="clientName"
            ...
            <div className="mb-5 flex flex-col gap-3">
                <label htmlFor="description" className="text-base text-(--white)/50">
                    Description
                </label>
                <textarea
                    id="description"
